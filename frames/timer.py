...
class Timer(ttk.Frame):
    def __init__(self, parent, controller, show_settings):
        ...
        self.stop_button = ttk.Button(button_container, text="Stop", state="disabled", command=self.stop_timer, cursor="hand2", style='PomodoroButton.TButton')
        self.stop_button.grid(row=0, column=1, sticky="EW", padx=5)

        reset_button = ttk.Button(button_container, text="Reset", command=self.reset_timer, cursor="hand2", style='PomodoroButton.TButton')
